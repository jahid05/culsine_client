import orderImg from "../../assets/images/dishe_11.png";
  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="min-h-screen space-y-12">
        <div className="">
          <div className="grid md:grid-cols-2 md:gap-36 gap-14">
            <div data-aos="fade-down"
     data-aos-easing="linear"
     data-aos-duration="1500" className="md:w-96 md:space-y-8 space-y-6 md:text-xl text-gray-500">
              <div className="ps-4">
     ...
     data-aos-duration="1500" className="flex justify-center">
              <img className="md:w-96 w-52" src={orderImg} alt="" />
            </div>
          </div>
        </div>
     ...
     data-aos-easing="linear"
     data-aos-duration="1500" className="flex justify-center">
            <img className="md:w-80 w-60" src={chef} alt="" />
          </div>
          <div data-aos="fade-down"
     data-aos-easing="linear"
